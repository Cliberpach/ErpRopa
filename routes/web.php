...
Route::group(
    ...
    function () {
        ...
        Route::prefix('almacenes/categorias')->group(function () {
            ...
            Route::get('getListSelect', 'Almacenes\CategoriaController@getListSelect')->name('almacenes.categoria.getListSelect');
        });
        //Marcas
        Route::prefix('almacenes/marcas')->group(function () {
            ...
            Route::get('getListSelect', 'Almacenes\MarcaController@getListSelect')->name('almacenes.marca.getListSelect');
        });
        //Productos
        ...
        Route::prefix('almacenes/colores')->group(function () {
            Route::get('index', 'Almacenes\ColorController@index')->name('almacenes.color.index');
            Route::get('getcolor', 'Almacenes\ColorController@getcolor')->name('getColor');
            Route::get('destroy/{id}', 'Almacenes\ColorController@destroy')->name('almacenes.color.destroy');
            ...
            Route::get('getListSelect', 'Almacenes\ColorController@getListSelect')->name('almacenes.color.getListSelect');
        });
        //Modelos
        Route::prefix('almacenes/modelo')->group(function () {
            Route::get('index', 'Almacenes\ModeloController@index')->name('almacenes.modelo.index');
            Route::get('getModelo', 'Almacenes\ModeloController@getModelo')->name('getModelo');
            Route::get('destroy/{id}', 'Almacenes\ModeloController@destroy')->name('almacenes.modelo.destroy');
            ...
            Route::get('getListSelect', 'Almacenes\ModeloController@getListSelect')->name('almacenes.modelo.getListSelect');
        });
        //Tallas
        Route::prefix('almacenes/talla')->group(function () {
            Route::get('index', 'Almacenes\TallaController@index')->name('almacenes.talla.index');
            Route::get('getTalla', 'Almacenes\TallaController@getTalla')->name('getTalla');
            Route::get('destroy/{id}', 'Almacenes\TallaController@destroy')->name('almacenes.talla.destroy');
            ...
            Route::get('getListSelect', 'Almacenes\TallaController@getListSelect')->name('almacenes.talla.getListSelect');
        });
        //Telas
        Route::prefix('almacenes/tela')->group(function () {
            Route::get('index', 'Almacenes\TelaController@index')->name('almacenes.tela.index');
            Route::get('getTela', 'Almacenes\TelaController@getTela')->name('getTela');
            Route::get('destroy/{id}', 'Almacenes\TelaController@destroy')->name('almacenes.tela.destroy');
            ...
            Route::get('getListSelect', 'Almacenes\TelaController@getListSelect')->name('almacenes.tela.getListSelect');
        });
        //Sub Modelo
        Route::prefix('almacenes/subModelo')->group(function () {
            Route::get('index', 'Almacenes\SubModeloController@index')->name('almacenes.submodelo.index');
            Route::get('getSubModelo', 'Almacenes\SubModeloController@getSubModelo')->name('getSubModelo');
            Route::get('destroy/{id}', 'Almacenes\SubModeloController@destroy')->name('almacenes.submodelo.destroy');
            ...
            Route::get('getListSelect', 'Almacenes\SubModeloController@getListSelect')->name('almacenes.submodelo.getListSelect');
        });
        //Temporada
        Route::prefix('almacenes/temporada')->group(function () {
            Route::get('index', 'Almacenes\TemporadaController@index')->name('almacenes.temporada.index');
            Route::get('getTemporada', 'Almacenes\TemporadaController@getTemporada')->name('getTemporada');
            ...
            Route::get('getListSelect', 'Almacenes\TemporadaController@getListSelect')->name('almacenes.temporada.getListSelect');
        });
        //Genero
        Route::prefix('almacenes/genero')->group(function () {
            Route::get('index', 'Almacenes\GeneroController@index')->name('almacenes.genero.index');
            Route::get('getGenero', 'Almacenes\GeneroController@getGenero')->name('getGenero');
            Route::get('destroy/{id}', 'Almacenes\GeneroController@destroy')->name('almacenes.genero.destroy');
            ...
            Route::get('getListSelect', 'Almacenes\GeneroController@getListSelect')->name('almacenes.genero.getListSelect');
