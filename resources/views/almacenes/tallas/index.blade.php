...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10 col-md-10">
        <h2 style="text-transform:uppercase"><b>Listado de Tallas del Producto terminado</b></h2>
        <ol class="breadcrumb">
...
<script>
    ...
    function limpiarError() {
        $('#talla_editar').removeClass("is-invalid")
        $('#error-talla').text('')
    }
    ...
    function guardarError() {
        $('#talla_guardar').removeClass("is-invalid")
        $('#error-talla-guardar').text('')
    }
    ...
    function eliminar(id) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                //Ruta Eliminar
                var url_eliminar = '{{ route('almacenes.talla.destroy', ':id') }}';
