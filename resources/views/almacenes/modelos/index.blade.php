...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10 col-md-10">
        <h2 style="text-transform:uppercase"><b>Listado de modelos del Producto terminado</b></h2>
        <ol class="breadcrumb">
...
<script>
    ...
    function obtenerData($id) {
        ...
        data.each(function(value, index) {
            if (value.id == $id) {
                ...
                $('#modelo_editar').val(value.nombre);
            }
        });
    ...
    function limpiarError() {
        $('#modelo_editar').removeClass("is-invalid")
        $('#error-modelo').text('')
    }
    ...
    function guardarError() {
        $('#modelo_guardar').removeClass("is-invalid")
        $('#error-modelo-guardar').text('')
    }
    ...
    function eliminar(id) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                //Ruta Eliminar
                var url_eliminar = '{{ route('almacenes.modelo.destroy', ':id') }}';
