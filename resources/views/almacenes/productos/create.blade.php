                                    ...
                                    {{-- <div class="col-lg-6 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <select id="medida" name="medida"
                                                class="select2_form form-control {{ $errors->has('medida') ? ' is-invalid' : '' }}"
                                                required>
                                                <option></option>
                                                @foreach (unidad_medida() as $medida)
                                                    <option value="{{ $medida->id }}"
                                                        {{ old('medida') == $medida->id ? 'selected' : '' }}>
                                                        {{ $medida->simbolo . ' - ' . $medida->descripcion }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-lg-6 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="peso_producto" placeholder="0.00" step="0.001"
                                                min="0" onkeypress="return filterFloat(event, this);"
                                                class="form-control {{ $errors->has('peso_producto') ? ' is-invalid' : '' }}"
                                                name="peso_producto" value="{{ old('peso_producto', 0.001) }}">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="nombre" name="nombre"
                                                ...
                                                value="{{ old('nombre') }}" maxlength="191"
                                            ...
                                            <div class="col-12 col-md-10">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="codigo_barra"
                                                        ...
                                                        name="codigo_barra" value="{{ old('codigo_barra') }}"
                                                        maxlength="20">
                                            ...
                                            <div class="col-12 col-md-2 d-none">
                                                <div class="form-group">
                                                    <button type="button" class="btn btn-primary btn-block"
                                                        title="Imprimir"><i class="fa fa-file-excel-o"></i></button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group row d-none">
                                    <div class="col-lg-6 col-xs-12">
                                        ...
                                        <input type="text" id="precio_venta_minimo" name="precio_venta_minimo"
                                            ...
                                            value="{{ old('precio_venta_minimo') }}" maxlength="15"
                                    ...
                                    <div class="col-lg-6 col-xs-12">
                                        ...
                                        <input type="precio_venta_maximo" id="precio_venta_maximo"
                                            ...
                                            value="{{ old('precio_venta_maximo') }}" maxlength="15"
                                            onkeypress="return filterFloat(event, this);">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <select class="select2_form form-control"
                                                    ...
                                                    id="moneda_cliente" disabled>
                                                    <option></option>
                                                    @foreach (tipos_moneda() as $tipo_moneda)
                                                        <option value="{{ $tipo_moneda->id }}"
                                                            {{ $tipo_moneda->descripcion === 'SOLES' ? 'selected' : '' }}>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    if (existe == true) {
                        ...
                        toastr.error(
                            'Es obligatorio el ingreso del Cliente Consumidor Normal y la moneda Soles.',
                            'Error');
                    }
