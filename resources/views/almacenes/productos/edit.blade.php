        ...
        <div class="col-lg-12">
            <div class="ibox">
                <div class="ibox-content">
                    <form action="{{ route('almacenes.producto.update', $producto->id) }}" method="POST"
                        id="form_actualizar_producto">
                        @csrf @method('PUT')
                        <div class="row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6 col-xs-12">
                                        ...
                                        <input type="text" id="stock_minimo" name="stock_minimo"
                                            ...
                                            value="{{ old('stock_minimo', $producto->stock_minimo) }}" maxlength="10"
                                    ...
                                    <div class="col-lg-6 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="peso_producto" placeholder="0.00" step="0.001"
                                                min="0" required onkeypress="return filterFloat(event, this);"
                                                class="form-control {{ $errors->has('peso_producto') ? ' is-invalid' : '' }}"
                                                name="peso_producto"
                                                value="{{ old('peso_producto', $producto->peso_producto) }}">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="nombre" name="nombre"
                                                ...
                                                value="{{ old('nombre', $producto->nombre) }}" maxlength="191"
                                            ...
                                            <div class="col-12 col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="codigo_barra"
                                                        class="form-control {{ $errors->has('codigo_barra') ? ' is-invalid' : '' }}"
                                                        name="codigo_barra"
                                            ...
                                            <div class="col-12 col-md-2">
                                                <div class="form-group">
                                                    <button type="button" class="btn btn-success btn-block"
                                                        title="Generar" onclick="generarCode()"><i
                                                ...
                                                <div class="col-12 col-md-2">
                                                    <div class="form-group">
                                                        <a class="btn btn-primary btn-block"
                                                            href="{{ route('almacenes.producto.codigoBarras', $producto->id) }}"
                                                            title="Imprimir"><i class="fa fa-file-excel-o"></i></a>
                                                    </div>
                                                </div>
                                            @endif
                                        </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <select id="marca" name="marca"
                                            ...
                                            required value="{{ old('marca', $producto->marca_id) }}">
                                            <option></option>
                                ...
                                <div class="col-lg-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <select id="almacen" name="almacen"
                                            value="{{ old('almacen', $producto->almacen_id) }}"
                                            class="select2_form form-control {{ $errors->has('almacen') ? ' is-invalid' : '' }}">
                                            <option></option>
                                            @foreach ($almacenes as $almacen)
                                                <option value="{{ $almacen->id }}"
                                                    {{ old('almacen', $producto->almacen_id) == $almacen->id ? 'selected' : '' }}>
                            ...
                            <div class="col-lg-6 col-xs-12">
                                ...
                                <div class="form-group row">
                                    {{-- <div class="col-lg-6 col-xs-12">
                                        ...
                                        <input type="text" id="stock" name="stock" readonly
                                            ...
                                            value="{{ old('stock', $producto->stock) }}" maxlength="10"
                                            onkeypress="return isNumber(event);" required>
                                        @if ($errors->has('stock'))
                                            <span class="invalid-feedback" role="alert">
                                    ...
                                    <div class="col-lg-12 col-xs-12">
                                        ...
                                        <div class="radio">
                                            <input type="radio" name="igv" id="igv_si" value="1"
                                                {{ $producto->igv == 1 ? 'checked' : '' }}>
                                            <label for="igv_si">
                                                SI
                                            </label>
                                        </div>
                                        ...
                                        <select class="autocomplete-producto select2_form form-control"
                                            ...
                                            @foreach (getColores() as $value)
                                                <option value="{{ $value->id }}">
                                                    {{ old('color_id', $producto->color_id) == $value->id ? 'selected' : '' }}>
                                                    {{ $value->nombre }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group row d-none">
                                    <div class="col-lg-6 col-xs-12">
                                        ...
                                        <input type="text" id="precio_venta_minimo" name="precio_venta_minimo"
                                            class="form-control {{ $errors->has('precio_venta_minimo') ? ' is-invalid' : '' }}"
                                            value="{{ old('precio_venta_minimo', $producto->precio_venta_minimo) }}"
                                    ...
                                    <div class="col-lg-6 col-xs-12">
                                        ...
                                        <input type="precio_venta_maximo" id="precio_venta_maximo"
                                            name="precio_venta_maximo"
                                            class="form-control {{ $errors->has('precio_venta_maximo') ? ' is-invalid' : '' }}"
                                            value="{{ old('precio_venta_maximo', $producto->precio_venta_maximo) }}"
                                            maxlength="15" onkeypress="return filterFloat(event, this);">
                                ...
                                <div class="form-group row">
                                    <div class="form-group col-lg-6 col-xs-12">
                                        ...
                                        <select class="autocomplete-producto select2_form form-control"
                                            ...
                                            @foreach (getModelos() as $value)
                                                <option value="{{ $value->id }}">
                                                    {{ old('modelo_id', $producto->modelo_id) == $value->id ? 'selected' : '' }}>
                                                    {{ $value->nombre }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group col-lg-6 col-xs-12">
                                        ...
                                        <select class="autocomplete-producto select2_form form-control"
                                            style="text-transform: uppercase; width:100%" name="sub_modelo_id" id="sub_modelo_id">
                                            <option></option>
                                            @foreach (getSubModelos() as $value)
                                                <option value="{{ $value->id }}">
                                                    {{ old('sub_modelo_id', $producto->sub_modelo_id) == $value->id ? 'selected' : '' }}>
                                                    {{ $value->nombre }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group col-lg-6 col-xs-12">
                                        ...
                                        <select class="autocomplete-producto select2_form form-control"
                                            style="text-transform: uppercase; width:100%" name="temporada_id" id="temporada_id">
                                            <option></option>
                                            @foreach (getTemporadas() as $value)
                                                <option value="{{ $value->id }}">
                                                    {{ old('temporada_id', $producto->temporada_id) == $value->id ? 'selected' : '' }}>
                                                    {{ $value->nombre }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group col-lg-6 col-xs-12">
                                        ...
                                        <select class="autocomplete-producto select2_form form-control"
                                            style="text-transform: uppercase; width:100%" name="genero_id" id="genero_id">
                                            <option></option>
                                            @foreach (getGeneros() as $value)
                                                <option value="{{ $value->id }}">
                                                    {{ old('genero_id', $producto->genero_id) == $value->id ? 'selected' : '' }}>
                                                    {{ $value->nombre }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <select class="select2_form form-control"
                                                    ...
                                                    @foreach (tipo_clientes() as $cliente)
                                                        <option value="{{ $cliente->descripcion }}">
                                                            {{ $cliente->descripcion }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <select class="select2_form form-control"
                                                    style="text-transform: uppercase; width:100%" name="moneda_cliente"
                                                    id="moneda_cliente">
                                                    <option></option>
                                                    @foreach (tipos_moneda() as $tipo_moneda)
                                                        <option value="{{ $tipo_moneda->id }}">
                                                            {{ $tipo_moneda->simbolo . ' - ' . $tipo_moneda->descripcion }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                                <div class="invalid-feedback"><b><span id="error-moneda"></span></b>
                                                </div>
                                            </div>
                                            <div class="col-md-2">
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    if (existe == true) {
                        ...
                        toastr.error(
                            'Es obligatorio el ingreso del Consumidor Normal y la moneda Soles.',
                            'Error');
                    }
