...
@can('restore', [Auth::user(), ['almacen.index', 'categoria.index', 'marca.index', 'producto.index',
    'nota_ingreso.index', 'nota_salida.index']])
    <li class="@yield('almacenes-active')">
        ...
        <ul class="nav nav-second-level collapse">
            ...
            @endcan
            <li class="@yield('color-active')"><a href="{{ route('almacenes.color.index') }}">Color</a></li>
            <li class="@yield('modelo-active')"><a href="{{ route('almacenes.modelo.index') }}">Modelo</a></li>
            <li class="@yield('tela-active')"><a href="{{ route('almacenes.tela.index') }}">Tela</a></li>
            <li class="@yield('talla-active')"><a href="{{ route('almacenes.talla.index') }}">Talla</a></li>
            <li class="@yield('submodelo-active')"><a href="{{ route('almacenes.submodelo.index') }}">Sub Modelo</a></li>
            <li class="@yield('temporada-active')"><a href="{{ route('almacenes.temporada.index') }}">Temporada</a></li>
            <li class="@yield('genero-active')"><a href="{{ route('almacenes.genero.index') }}">Genero</a></li>
    ...
    <li class="@yield('consulta-active')">
        ...
        <ul class="nav nav-second-level collapse">
            ...
            @can('haveaccess', 'consulta_utilidad_bruta.index')
                <li class="@yield('utilidad_bruta-active')"><a href="{{ route('consultas.caja.utilidad.index') }}">Utilidad Bruta</a>
                </li>
            @endcan
        </ul>
    </li>
...
@can('restore', [Auth::user(), ['kardex_proveedor.index', 'kardex_cliente.index', 'kardex_producto.index',
    'kardex_salida.index', 'kardex_venta.index']])
                ...
                <li class="@yield('salida-kardex-active')">
                    ...
                    <ul class="nav nav-third-level">
                        @can('haveaccess', 'kardex_venta.index')
                            <li class="@yield('salida-ventas-active')"><a href="{{ route('consultas.kardex.ventas.index') }}">Ventas</a>
                            </li>
                        @endcan
                        @can('haveaccess', 'kardex_salida.index')
                            <li class="@yield('salida-notas-active')"><a href="{{ route('consultas.kardex.notas.index') }}">Salidas</a>
                            </li>
                        @endcan
                    </ul>
                </li>
...
@can('restore', [Auth::user(), ['colaborador.index', 'vendedor.index', 'empresa.index', 'condicion.index',
    'tabla.index', 'configuracion.index']])
